...
{
    public AssetMainSchdMaster_DTO newAssetMainSchd(AssetMainSchdMaster_DTO assetMainSchdMasterDTO);
    ...
    public void updAssetMainSchd(AssetMainSchdMaster_DTO assetMainSchdMasterDTO);
